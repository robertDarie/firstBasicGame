    ...
    public void keyPressed(KeyEvent e) {
        ...
        for (int i = 0; i < handler.object.size(); i++) {
            ...
            if (tempObj.getId() == ID.Player) {
                if (key == KeyEvent.VK_W||key==KeyEvent.VK_UP) {tempObj.setVelY(-5); keyDown[0]=true;}
                if (key == KeyEvent.VK_S||key==KeyEvent.VK_DOWN) {tempObj.setVelY(5); keyDown[1]=true;}
                if (key == KeyEvent.VK_D||key==KeyEvent.VK_RIGHT) {tempObj.setVelX(5); keyDown[2]=true;}
                if (key == KeyEvent.VK_A||key==KeyEvent.VK_LEFT) {tempObj.setVelX(-5); keyDown[3]=true;}
            }
        }
